 ...
 * className AND style, and defaults to a plain inline style that fills its
 * parent — so the orb renders correctly WITHOUT Tailwind installed. Give the
 * parent an explicit size (this component fills 100% of it).
 *
 * Loads its noise texture from /orb-perlin-noise.png (vendored in public/).
 * Reads document.documentElement.classList.contains("dark") for the dark look.
 */
...
export function Orb({
  ...
  // No Tailwind dependency: default to a plain inline style that fills the
  // parent. className/style still let a caller override or extend it.
  return (
    <div
      className={className}
